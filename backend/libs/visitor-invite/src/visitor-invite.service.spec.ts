...
describe("VisitorInviteService", () => {
    ...
    const queryBusMock = {
        execute: jest.fn((query: IQuery) => {
            if (query instanceof GetInvitesQuery) {
                ...
                query instanceof GetNumberOfCancellationsOfResidentQuery
            ) {
                if (query.email === "admin@mail.com") {
                    return 2;
                } else {
    ...
    const mailServiceMock = {
        ...
        sendCancelNotice: jest.fn(() => {
            return { messageId: "id" };
        }),
    };

    const parkingServiceMock = {
        isParkingAvailable: jest.fn(() => {
            return true;
        }),
    ...
    describe("getNumInvitesPerDate", () => {
        it("should return an array of dates corresponding to given range", async () => {
            const invites = await service.getNumInvitesPerDate(
                "2022-04-01",
                "2022-09-01",
            );
    ...
    describe("GetTotalNumberOfInvitesOfResident", () => {
        it("should return the number of invites per resident", async () => {
            const numInvites = await service.getTotalNumberOfInvitesOfResident(
                "admin@mail.com",
            );
    ...
    describe("getTotalNumberOfCancellationsOfResident", () => {
        it("should return the number of invites cancelled by resident", async () => {
            const numCancels =
                await service.getTotalNumberOfCancellationsOfResident(
                    "admin@mail.com",
                );
    ...
    describe("getTotalNumberOfSleepoversOfResident", () => {
        it("should return the number of sleepovers of the resident", async () => {
            const numSleepovers =
                await service.getTotalNumberOfSleepoversOfResident(
                    "admin@mail.com",
                );
    ...
    describe("getTotalNumberOfSleepoversThisMonthOfResident", () => {
        it("should return the number of sleepovers of the resident for this month", async () => {
            const numSleepovers =
                await service.getTotalNumberOfSleepoversThisMonthOfResident(
                    "admin@mail.com",
                );
    ...
    describe("createInviteForBulkSignIn", () => {
        it("should create bulk invite", async () => {
            ...
            // Act
            const response = await service.createInviteForBulkSignIn(
                3,
                "user",
                "visitor",
                "name",
    ...
    describe("cancel invite", () => {
        it("should cancel invite", async () => {
            ...
            jest.spyOn(commandBusMock as any, "execute").mockReturnValueOnce({
                userEmail: "mail",
            });
        ...
        it("should not cancel invite when email dont match", async () => {
            ...
            try {
                const response = await service.cancelInvite("email", "id");
            } catch (e) {
                expect(e.message).toEqual("Invite was not issued by: email");
            }
        });
        it("should not cancel invite when invite not found", async () => {
            ...
            try {
                ...
                expect(e.message).toEqual("Invite not found with ID: id");
            }
        });
    });
    ...
    describe("getInvitesByIDForReceptionistSearch", () => {
        it("should getInvitesByIDForReceptionistSearch", async () => {
            ...
            const response = await service.getInvitesByIDForReceptionistSearch(
                "m",
            );
    ...
    describe("getMostUsedInviteData", () => {
        it("should getMostUsedInviteData", async () => {
            ...
            try {
                const response = await service.getMostUsedInviteData("");
            } catch (e) {
                expect(e.message).toEqual("No Invites to make suggestion");
            }
        });
    });
    ...
    describe("getInviteForSignInData", () => {
        it("should get the invite needed for sign in", async () => {
            const response = await service.getInviteForSignInData(
                "9911305129086",
                "2022/09/22",
                "true",
            );
    ...
    describe("getInviteForSignOutData", () => {
        it("should get the invite needed for sign in", async () => {
            const response = await service.getInviteForSignOutData(
                "9911305129086",
            );
            expect(response).toEqual(1);
        });
    ...
    describe("getNumInvitesPerDateOfUser", () => {
        it("should get the visits for the day of the user", async () => {
            const response = await service.getNumInvitesPerDateOfUser(
                "2022/09/22",
                "2022/09/23",
                "myman@male.com",
            );
    ...
    describe("getTotalNumberOfVisitsOfResident", () => {
        it("should get the total number of visits the resident has had", async () => {
            const response = await service.getTotalNumberOfVisitsOfResident(
                "Joe@gmail.com",
            );
    ...
    describe("getInvitesForUserType", () => {
        it("should get the total number of visits the resident has had", async () => {
            const findOneMock = jest
                .spyOn(userService, "getUsersByType")
                .mockReturnValueOnce(Promise.resolve([{ email: "dorithy" }]));
