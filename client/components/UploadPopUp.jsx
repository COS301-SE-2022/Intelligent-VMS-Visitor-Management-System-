        ...
        <div className="mt-2 w-full">
            <div className="m-4">
                <div className="flex w-full items-center justify-center">
                    <label className="h-50 flex w-full flex-col rounded-lg border-2 border-dashed border-blue-200 pt-10 hover:border-secondary">
                        <div className="flex flex-col items-center justify-center ">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-12 w-12 group-hover:text-gray-600"
                                fill="white"
            ...
            <div className="flex justify-center p-2">
                <button
                    className="w-full rounded bg-secondary py-2 text-white shadow-xl"
