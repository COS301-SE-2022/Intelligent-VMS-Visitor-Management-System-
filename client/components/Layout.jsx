...
const Layout = ({ children }) => {
    ...
    return (
            <div className="flex min-h-screen flex-col items-center justify-center py-2 font-main">
                <Head>
                    <title>VMS</title>
