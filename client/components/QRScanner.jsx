...
const QRScanner = ({
    ...
    return (
      ...
      <div classN="flex mt-3 justify-center">
        <span classN="fill-current text-error w-6 h-full align-middle fill-bg-error"><TiWarning size="lg" color="bg-error"/></span>
        <p classN="ml-2 font-bold text-error">Ensure that QR Code is visible</p>
      </div>
        </div>
    );
};
